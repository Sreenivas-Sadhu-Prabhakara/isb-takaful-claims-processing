package com.bank.islamic.takafulclaimsprocessing.model;
...
/**
 * The BIAN control record for this service domain: "Takaful Claim Procedure".
 *
 ...
 * to its asset type (Takaful Claim). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Takaful Claim Procedure";
